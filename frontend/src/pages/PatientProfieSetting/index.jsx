...
import Image1 from '../../assets/img/patients/patient.jpg';

import Patient1 from '../../assets/img/patients/patient.jpg'
                                ...
                                <div className="card-body">
                                    ...
                                    <form>
                                                    ...
                                                    <div className="change-avatar">
                                                        ...
                                                        <div className="upload-img">
                                                            <div className="change-photo-btn">
                                                                <span><i
                                                                    className="fa fa-upload"/> Upload Photo</span>
                                        ...
                                        <div className="submit-section">
                                            <button type="submit" className="btn btn-primary submit-btn">Save Changes
                                            </button>
                                        </div>
                                    </form>
                                     {/*/Profile Settings Form */}
